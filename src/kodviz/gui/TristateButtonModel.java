 ...
 */
public abstract interface TristateButtonModel extends ButtonModel
{
    /**
     ...
     *
     * @param tristate Wheter or not the button should be in tristate.
     */
    public abstract void setTristate(boolean tristate);
}
