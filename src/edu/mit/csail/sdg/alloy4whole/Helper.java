...
final class Helper {
    ...
    public static synchronized String alloyHome() {
        ...
        File tempfile=new File(temp+File.separatorChar+"alloy4tmp28-"+(username==null?"":username));
        tempfile.mkdirs();
    ...
    public static void clearTemporarySpace() {
        ...
        for(int i=1; i<28; i++) iterateTemp(temp+File.separatorChar+"alloy4tmp"+i+"-"+username, true);
    }
