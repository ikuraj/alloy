...
public final class A4Solution {
    ...
    /** If not empty, it maps every Sig/Field (and possibly even some parameterless Func) to a Kodkod expression. */
    ...
    Map<Relation,Type> skolem2type, Map<Formula,List<Object>> core, Iterable<Formula> kCore)
    throws Err {
