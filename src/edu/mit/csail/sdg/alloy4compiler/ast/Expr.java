 ...
 * 
 * errors.size()>0 => type==null
 * 
 * if at least one subnode has null type
 *     { NO NEW ERROR will be generated by this node; this node's type will be null; }
 * else if the subnodes's types are not legal for this node
 *     { ONE NEW ERROR will be generated by this node; this node's type will be null; }
 * else
 *     { NO NEW ERROR will be generated by this node; this node's type will be the bounding type; }
 */
...
public abstract class Expr {
    ...
    public final JoinableList<Err> warnings;
     ...
     */
    Expr (Pos pos, Type type, int mult, long weight, JoinableList<Err> errors, JoinableList<Err> warnings) {
        this.pos=(pos==null ? Pos.UNKNOWN : pos);
        this.mult=(mult<0 || mult>2) ? 0 : mult;
        this.type=type;
        this.weight=weight;
        ErrorType e=null;
        if (type!=null && type.size()==0 && !type.is_int && !type.is_bool) e=new ErrorType(span(), "This expression failed to be typechecked");
        this.errors=(e==null ? errors : errors.append(e));
    ...
    Expr (Pos pos, Type type, int mult, long weight) {
        ...
        ErrorType e=null;
        if (type!=null && type.size()==0 && !type.is_int && !type.is_bool) e=new ErrorType(span(), "This expression failed to be typechecked");
        this.errors=(e==null ? JoinableList.emptylist : new JoinableList<Err>(e));
        this.warnings=JoinableList.emptylist;
    }
    ...
    public final Expr and(Expr x) throws Err {
        ...
        return ExprBinary.Op.AND.make(span().merge(x.span()), this, x);
    }
