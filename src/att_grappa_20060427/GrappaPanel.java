...
public class GrappaPanel extends javax.swing.JPanel
    implements
	att_grappa_20060427.GrappaConstants,
	ComponentListener,
	...
	Scrollable
{
	...
	if(scaleToFit || scaleToSize != null) {
		...
		// The following 2 lines of code are added by the Alloy developers,
		// to ensure the scroll bars won't be activated (if this GrappaPanel is inside a JScrollPane)
		if (scaleToWidth >100) scaleToWidth-=10;
		if (scaleToHeight>100) scaleToHeight-=10;
	    } else {
		...
		new GrappaBox(oldTransform.createTransformedShape(zoomBox).getBounds2D());
    ...
    /* Commented out since it causes occasional crashes
	if(inverseTransform == null || grappaListener == null || inMenu) return;
