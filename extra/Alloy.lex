...
import edu.mit.csail.sdg.alloy4compiler.ast.ExprName;
...
%{
 ...
 private final Symbol alloy_id(String txt) throws Err {
    Pos p=alloy_here(txt); return new Symbol(CompSym.ID, p, ExprName.make(p,txt,world));
 }
 private final Symbol alloy_num(String txt) throws Err {
    ...
    return new Symbol(CompSym.NUMBER, p, ExprConstant.makeNUMBER(world,p,n));
 }
%}
